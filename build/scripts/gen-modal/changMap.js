...
/>
<!-- 新增Modal -->`,
        "/** 新增import */": `import ${firstWordUpper(stringToHump(name))}Modal from "${importPath}/${firstWordUpper(stringToHump(name))}Modal.vue";
import { provide${firstWordUpper(stringToHump(name))}Modal } from "${importPath}/use-${formatToLowerCase(name)}-modal";
/** 新增import */`,
        "/** 新增provide */": `const {
...
export const useModalChangeMap = (name) => {
